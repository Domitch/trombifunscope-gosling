...
public class Student {
    ...
    public Student(int id, LocalDate date_of_birth, String real_name, String fantastic_name, String photo, String theme_song, String power, String weakness, String element) {
        this.id = id;
        this.date_of_birth = date_of_birth;
        this.real_name = real_name;
        this.fantastic_name = fantastic_name;
